...
Le projet FeedingBias est basé sur une démarche de science participative. Les plateformes des réseaux sociaux comme Facebook ou Twitter refusent de plus en plus l'accès à leurs données aux chercheurs. Pour contourner cet obstacle, nous proposons aux participants à cette enquête de nous donner accès, de manière très contrôlée, à des informations sur leurs comptes sur Twitter, Instagram et Facebook ainsi que sur leur activité sur YouTube. Afin de mieux les connaître, nous leur demandons aussi de répondre à quelques questions.

Nous ne collectons que des informations sur l'accès à l'information médiatique, en aucun cas des données concernant les relations personnelles et la vie privée des individus. Par ailleurs nous anonymisons toutes les données que nous collectons. Vous pouvez participer à cette enquête en cliquant sur le bouton ci-dessous :
